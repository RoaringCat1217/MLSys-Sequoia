...
parser.add_argument('--draft_model', type=str, help='draft model')
parser.add_argument('--tiny_model', type=str, help='tiny model')
...
parser.add_argument('--spec_steps', type=int, default=6, help='steps to double-draft')
...
graph_capture_list = list(range(args.spec_steps + 2))
